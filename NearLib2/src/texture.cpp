...
void Texture::load(const std::string& path){
  HRESULT res = DirectX::CreateWICTextureFromFileEx(window.getDevice(), widen(path).c_str(), 0, D3D11_USAGE_DEFAULT, D3D11_BIND_SHADER_RESOURCE, 0, 0, DirectX::WIC_LOADER_DEFAULT, nullptr, &textureView);
